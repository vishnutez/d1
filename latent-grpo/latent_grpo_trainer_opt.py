...
class LatentGRPOTrainer(GRPOTrainer):
    ...
    def _generate_and_score_completions(
        ...
        for b, eval_time_step in enumerate(eval_time_steps):
            selected_completion_ids[b, idx] = completion_ids[b, eval_time_step]
            idx += 1
        ...
        if self.args.returns_mode == 'sequence_return':
            advantages_per_step += self.args.lambda1 * incremental_advantages  # (batch_size, logps_eval_num_steps)
